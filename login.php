...
<body class="gp-auth">
    ...
    <div class="auth-card">
        ...
        <h1>Вход в аккаунт</h1><p class="gp-auth-intro">Управляйте счетами, платежами и интеграциями.</p>
        <form method="POST">
            <label class="form-label">Логин или Email</label>
            <input type="text" name="login" id="login" autocomplete="username" class="form-control" placeholder="Введите логин" required autofocus>
